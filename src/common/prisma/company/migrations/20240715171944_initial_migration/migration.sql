...
CREATE TABLE "company_country" (
    ...
    CONSTRAINT "company_country_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "company_country_name_key" ON "company_country"("name");

-- CreateIndex
CREATE UNIQUE INDEX "company_country_iso2_key" ON "company_country"("iso2");

-- CreateIndex
CREATE UNIQUE INDEX "company_country_iso3_key" ON "company_country"("iso3");

-- CreateIndex
CREATE UNIQUE INDEX "company_state_name_key" ON "company_state"("name");

-- CreateIndex
CREATE UNIQUE INDEX "company_state_iso2_key" ON "company_state"("iso2");

-- CreateIndex
CREATE UNIQUE INDEX "company_user_employeeId_key" ON "company_user"("employeeId");
...
-- AddForeignKey
ALTER TABLE "company_state" ADD CONSTRAINT "company_state_countryId_fkey" FOREIGN KEY ("countryId") REFERENCES "company_country"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "company_user" ADD CONSTRAINT "company_user_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "core_employee"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "company_user" ADD CONSTRAINT "company_user_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "core_role"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "company_user" ADD CONSTRAINT "company_user_photoId_fkey" FOREIGN KEY ("photoId") REFERENCES "core_file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "user_email" ADD CONSTRAINT "user_email_userId_fkey" FOREIGN KEY ("userId") REFERENCES "company_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "user_phone" ADD CONSTRAINT "user_phone_userId_fkey" FOREIGN KEY ("userId") REFERENCES "company_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "user_address" ADD CONSTRAINT "user_address_userId_fkey" FOREIGN KEY ("userId") REFERENCES "company_user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_address" ADD CONSTRAINT "user_address_countryId_fkey" FOREIGN KEY ("countryId") REFERENCES "company_country"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_address" ADD CONSTRAINT "user_address_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "company_state"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_next_of_kin" ADD CONSTRAINT "user_next_of_kin_userId_fkey" FOREIGN KEY ("userId") REFERENCES "company_user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_relation" ADD CONSTRAINT "user_relation_userId_fkey" FOREIGN KEY ("userId") REFERENCES "company_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "core_message" ADD CONSTRAINT "core_message_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "company_user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
